...
import "./Banner.css";
import usflag from "/src/assets/FSDP/assets/img/us_flag_small.png";
import icongov from "/src/assets/FSDP/assets/img/icon-dot-gov.svg";
import iconhttps from "/src/assets/FSDP/assets/img/icon-https.svg";
                ...
                <header className="usa-banner__header">
                    <div className="usa-banner__inner">
                        <div className="grid-col-auto">
                                <img aria-hidden="true" className="usa-banner__header-flag" src={usflag} alt="U.S. Flag"/>
                        </div>
